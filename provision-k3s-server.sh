...
k3s_version="${1:-v1.30.2+k3s1}"; shift
k3s_token="$1"; shift
...
# install k3s.
# see server arguments at e.g. https://github.com/k3s-io/k3s/blob/v1.30.2+k3s1/pkg/cli/cmds/server.go#L576-L584
...
# e.g. s1     Ready    control-plane,master   3m    v1.30.2+k3s1
...
# see https://github.com/k3s-io/k3s/blob/v1.30.2+k3s1/manifests/traefik.yaml
# see https://github.com/traefik/traefik-helm-chart/blob/v25.0.3/traefik/values.yaml
...
# NB the default users are generated at https://github.com/k3s-io/k3s/blob/v1.30.2+k3s1/pkg/daemons/control/deps/deps.go#L233-L261
