...
k3s_version="${1:-v1.17.3+k3s1}"; shift
k3s_token="$1"; shift
ip_address="$1"; shift
...
# install k3s.
# see server arguments at e.g. https://github.com/rancher/k3s/blob/v1.17.3+k3s1/pkg/cli/cmds/server.go#L49
...
# e.g. s1     Ready    master   3m    v1.17.3+k3s1
...
# see https://github.com/rancher/k3s/blob/v1.17.3+k3s1/scripts/download#L21
