...
k3s_version="${1:-v1.29.5+k3s1}"; shift
k3s_token="$1"; shift
...
# install k3s.
# see server arguments at e.g. https://github.com/k3s-io/k3s/blob/v1.29.5+k3s1/pkg/cli/cmds/server.go#L573-L581
...
# e.g. s1     Ready    control-plane,master   3m    v1.29.5+k3s1
...
# see https://github.com/k3s-io/k3s/blob/v1.29.5+k3s1/manifests/traefik.yaml
...
# NB the default users are generated at https://github.com/k3s-io/k3s/blob/v1.29.5+k3s1/pkg/daemons/control/deps/deps.go#L233-L261
