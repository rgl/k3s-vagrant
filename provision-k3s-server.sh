...
k3s_version="${1:-v1.26.11+k3s2}"; shift
k3s_token="$1"; shift
...
# install k3s.
# see server arguments at e.g. https://github.com/k3s-io/k3s/blob/v1.26.11+k3s2/pkg/cli/cmds/server.go#L564-L572
...
# see https://github.com/k3s-io/k3s/blob/v1.26.11+k3s2/manifests/traefik.yaml
...
# NB the default users are generated at https://github.com/k3s-io/k3s/blob/v1.26.11+k3s2/pkg/daemons/control/deps/deps.go#L235-L263
