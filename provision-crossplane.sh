...
crossplane_provider_aws_s3_version="${1:-1.11.0}"; shift || true
...
#   crossplane/crossplane  1.16.0         1.16.0       Crossplane is an open source Kubernetes add-on ...
...
# see https://marketplace.upbound.io/providers/upbound/provider-aws-s3/v1.11.0
kubectl apply -f - <<EOF
