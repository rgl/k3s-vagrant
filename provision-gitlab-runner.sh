...
gitlab_runner_chart_version="${1:-0.21.1}"; shift
...
#     gitlab/gitlab-runner 0.21.1        13.0.1      GitLab Runner
...
#       https://gitlab.com/gitlab-org/charts/gitlab-runner/-/blob/v0.21.1/values.yaml
