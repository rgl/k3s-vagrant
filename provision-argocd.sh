...
argocd_cli_version="${1:-2.11.0}"; shift || true
argocd_chart_version="${1:-6.9.3}"; shift || true
...
#     argo/argo-cd    6.9.3         v2.11.0     A Helm chart for Argo CD, a declarative, GitOps...
helm search repo argo/argo-cd --versions | head -10

# set the configuration.
# NB the default values are described at:
#       https://github.com/argoproj/argo-helm/blob/argo-cd-6.9.3/charts/argo-cd/values.yaml
