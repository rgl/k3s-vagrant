...
argocd_cli_version="${1:-2.11.2}"; shift || true
argocd_chart_version="${1:-6.11.1}"; shift || true
...
#     argo/argo-cd    6.11.1        v2.11.2     A Helm chart for Argo CD, a declarative, GitOps...
helm search repo argo/argo-cd --versions | head -10

# set the configuration.
# NB the default values are described at:
#       https://github.com/argoproj/argo-helm/blob/argo-cd-6.11.1/charts/argo-cd/values.yaml
