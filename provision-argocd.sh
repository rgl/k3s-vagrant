...
argocd_cli_version="${1:-2.11.7}"; shift || true
argocd_chart_version="${1:-7.3.11}"; shift || true
...
#     argo/argo-cd    7.3.11        v2.11.7     A Helm chart for Argo CD, a declarative, GitOps...
