...
K3S_CHANNEL = 'latest'
# renovate: datasource=github-releases depName=k3s-io/k3s extractVersion=(?<version>1\.30\..+)
...
K8S_DASHBOARD_CHART_VERSION = 'v7.5.0'
...
METALLB_CHART_VERSION = '6.3.8' # app version: 0.14.5
...
RELOADER_CHART_VERSION = '1.0.119' # app version: 1.0.119
...
ARGOCD_CHART_VERSION = '7.3.10' # app version 2.11.6.
...
CROSSPLANE_PROVIDER_AWS_S3_VERSION = '1.9.0'
