...
METALLB_CHART_VERSION = '5.0.0' # app version: 0.14.3
...
GITLAB_RUNNER_CHART_VERSION = '0.62.1'
...
ARGOCD_CHART_VERSION = '6.7.2' # app version 2.10.3.
...
CROSSPLANE_PROVIDER_AWS_S3_VERSION = '1.2.0'
